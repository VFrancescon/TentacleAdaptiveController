...
MatrixXd CompClass::EvaluateK(std::vector<Link> &iLinks)
{
...
void CompClass::DirectKinematics(std::vector<PosOrientation> &iPosVec, std::vector<Joint> &iJoints, std::vector<Link> &iLinks)
{
...
MatrixXd CompClass::EvaluateJacobian(std::vector<PosOrientation> &iPosVec)
{
    /**
     * @note
     *
...
MatrixXd CompClass::MagtoFieldMap(std::vector<Joint> &iJoints)
{
...
Matrix3d CompClass::SkewMatrix(Vector3d src)
{
    Matrix3d Skew;
    Skew = Matrix3d::Zero();
    Skew << 0, -src[2], src[1],
...
VectorXd CompClass::StackAngles(std::vector<Joint> &iJoints)
{
...
MatrixXd CompClass::VerticalStack(MatrixXd M1, MatrixXd M2)
{
...
MatrixXd CompClass::StackDiagonals(std::vector<Matrix3d> matrices)
{
...
Vector3d CompClass::RotateField(Vector3d field, Vector3d rotationAngles)
{
...
Matrix3d CompClass::RotationZYX(Matrix3d src, Vector3d jointAngles)
{
...
void CompClass::adjustStiffness(std::vector<Link> &iLinks, double EMulitplier)
{
    dfltValues MechPpts;
...
void CompClass::adjustStiffness(std::vector<Link> &iLinks, double EMulitplier, int LengthMultiplier)
{
    dfltValues MechPpts;
...
Vector3d CompClass::CalculateField(std::vector<Link> &iLinks, std::vector<Joint> &iJoints,
...
MatrixXd CompClass::backwardsQ(std::vector<Link> &iLinks, std::vector<Joint> &iJoints,
